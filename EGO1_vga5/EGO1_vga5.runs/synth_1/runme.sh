...
HD_PWD='E:/FPGA-Projects/EGO1_VGA/EGO1_vga5/EGO1_vga5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vga5.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vga5.tcl
