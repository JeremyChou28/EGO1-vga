...
HD_PWD='E:/FPGA-Projects/EGO1_VGA/EGO1_vga5/EGO1_vga5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vga5.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source vga5.tcl -notrace
