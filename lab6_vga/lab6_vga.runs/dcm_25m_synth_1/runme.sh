...
HD_PWD='E:/FPGA-Projects/lab6_vga/lab6_vga.runs/dcm_25m_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dcm_25m.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dcm_25m.tcl
