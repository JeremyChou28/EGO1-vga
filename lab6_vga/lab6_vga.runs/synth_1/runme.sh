...
HD_PWD='E:/FPGA-Projects/lab6_vga/lab6_vga.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_flyinglogo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_flyinglogo.tcl
