...
HD_PWD='E:/FPGA-Projects/lab6_vga/lab6_vga.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_flyinglogo.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_flyinglogo.tcl -notrace
