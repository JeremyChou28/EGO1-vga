...
HD_PWD='E:/FPGA-Projects/EGO1_VGA/EGO1_vga2/EGO1_vga2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vga2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vga2.tcl
