...
HD_PWD='E:/FPGA-Projects/EGO1_VGA/EGO1_vga2/EGO1_vga2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vga2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source vga2.tcl -notrace
