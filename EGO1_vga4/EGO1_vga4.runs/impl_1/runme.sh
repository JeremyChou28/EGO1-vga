...
HD_PWD='E:/FPGA-Projects/EGO1_VGA/EGO1_vga4/EGO1_vga4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vga4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source vga4.tcl -notrace
