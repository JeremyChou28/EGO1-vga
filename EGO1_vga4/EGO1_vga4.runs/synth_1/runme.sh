...
HD_PWD='E:/FPGA-Projects/EGO1_VGA/EGO1_vga4/EGO1_vga4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vga4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vga4.tcl
