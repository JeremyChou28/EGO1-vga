...
HD_PWD='E:/FPGA-Projects/EGO1_VGA/EGO1_vga3/EGO1_vga3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vga3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source vga3.tcl -notrace
