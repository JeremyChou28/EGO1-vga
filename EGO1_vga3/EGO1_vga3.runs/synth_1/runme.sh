...
HD_PWD='E:/FPGA-Projects/EGO1_VGA/EGO1_vga3/EGO1_vga3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vga3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vga3.tcl
