...
HD_PWD='E:/FPGA-Projects/EGO1_vga1/EGO1_vga1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vga1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vga1.tcl
