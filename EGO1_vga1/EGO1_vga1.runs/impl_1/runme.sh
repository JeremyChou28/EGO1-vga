...
HD_PWD='E:/FPGA-Projects/EGO1_vga1/EGO1_vga1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vga1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source vga1.tcl -notrace
